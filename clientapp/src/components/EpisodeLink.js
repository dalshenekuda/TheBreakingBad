...
const EpisodeLink = ({episode}) => {
    return (
        <div className="episodeBlock flex">
            ...
            <Link className="episodeLink md:m-6 m-1 mt-4  block transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-purple-500 duration-300" to={`/episodes/${episode.episode_id}`}>
